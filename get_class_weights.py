...
image_dir = "./IronData_Camvid_train_val/trainannot"
image_files = [os.path.join(image_dir, file) for file in os.listdir(image_dir) if file.endswith('.png')]

def ENet_weighing(image_files=image_files, num_classes=4):
    '''
...
if __name__ == "__main__":
    print(median_frequency_balancing(image_files, num_classes=4))
